#!/bin/bash
#SBATCH --job-name=rank_filt_cil_AS30plus5_on_ASplus5_w_KLD
...
#SBATCH --output=/pfs/lustrep2/projappl/project_462000765/casciott/continual_learning/batch_jobs/outputs/rank_filt_F1_cil_train_AS30plus5_FT_full_n_KLDorCOS_T10_IMP-23_no_posweight_on_ASplus5/out.txt
#SBATCH --error=/pfs/lustrep2/projappl/project_462000765/casciott/continual_learning/batch_jobs/outputs/rank_filt_F1_cil_train_AS30plus5_FT_full_n_KLDorCOS_T10_IMP-23_no_posweight_on_ASplus5/err.txt

cd /pfs/lustrep2/projappl/project_462000765/casciott/continual_learning
...
MODEL_NAME="trained_rank_filt_F${FILTER_NR}_cil_model_${MODEL}_${NR_OF_CLASSES}plus${CIL_NR_OF_CLASSES}_FT_full_on_${DATASET}_${CIL_NR_OF_CLASSES}_n_KLDorCOS_T${T}_IMP${CLASS_IMPACT}_no_posweight_${EPOCHS}epochs.pt"

# Desired destination folder of the trained model states
MODEL_STATE_DEST='/pfs/lustrep2/projappl/project_462000765/casciott/continual_learning/'
...
--no_pos_weight \
--weight_decay 0 \
--model_state_dest "$MODEL_STATE_DEST"
