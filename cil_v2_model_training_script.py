...
# Main differences to v1:
# Class impact is not used i.e. same as IMP=1. 
# KLD is weighted slightly adaptively and more highly in general
# KLD reduction is the default 'mean' instead of the mathematical definition 'batchmean'.
# Alternative validation loss strategies will be tried out: mAp, maybe F1 score. There is a chance that the small cil datasets will not perform at all with these metrics but this will have to be verified.
...
if __name__ == '__main__':
    ...
    print(f"KLD weight is: {KLD_weight}")
