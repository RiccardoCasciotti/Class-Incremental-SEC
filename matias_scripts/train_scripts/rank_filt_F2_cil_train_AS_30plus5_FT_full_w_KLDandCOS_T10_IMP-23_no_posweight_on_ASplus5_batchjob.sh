...
#SBATCH --output=outputs/train_outputs/rank_filt_F2_cil_train_AS30plus5_FT_full_w_KLDandCOS_T10_IMP-23_no_posweight_on_ASplus5_out.txt
#SBATCH --error=outputs/train_outputs/rank_filt_F2_cil_train_AS30plus5_FT_full_w_KLDandCOS_T10_IMP-23_no_posweight_on_ASplus5_err.txt
...
PATH_TO_FILTER_SCORE_DIR="/pfs/lustrep2/projappl/project_462000765/matias/scripts/outputs/PANNs_CNN14_filter_scores_per_layer/"
MODEL_NAME="trained_rank_filt_F${FILTER_NR}_cil_model_${MODEL}_${NR_OF_CLASSES}plus${CIL_NR_OF_CLASSES}_FT_full_on_${DATASET}_${CIL_NR_OF_CLASSES}_w_KLDandCOS_T${T}_IMP${CLASS_IMPACT}_no_posweight_${EPOCHS}epochs.pt"
