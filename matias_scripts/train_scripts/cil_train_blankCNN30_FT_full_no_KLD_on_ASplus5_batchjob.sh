...
#SBATCH --output=outputs/train_outputs/cil_train_blankCNN30_FT_full_no_KLD_on_ASplus5_out.txt
#SBATCH --error=outputs/train_outputs/cil_train_blankCNN30_FT_full_no_KLD_on_ASplus5_err.txt
...
MODEL_NAME="trained_cil_model_blankCNN30plus5_FT_full_on_${DATASET}_${CIL_NR_OF_CLASSES}_no_KLD_${EPOCHS}epochs.pt"
