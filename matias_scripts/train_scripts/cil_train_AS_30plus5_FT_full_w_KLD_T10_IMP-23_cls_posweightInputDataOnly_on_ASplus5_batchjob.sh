...
#SBATCH --output=outputs/train_outputs/cil_train_AS30plus5_FT_full_w_KLD_T10_IMP-23_cls_posweightInputDataOnly_on_ASplus5_out.txt
#SBATCH --error=outputs/train_outputs/cil_train_AS30plus5_FT_full_w_KLD_T10_IMP-23_cls_posweightInputDataOnly_on_ASplus5_err.txt
...
MODEL_NAME="trained_cil_model_${MODEL}_${NR_OF_CLASSES}plus${CIL_NR_OF_CLASSES}_FT_full_on_${DATASET}_${CIL_NR_OF_CLASSES}_w_KLD_T${T}_IMP${CLASS_IMPACT}_cls_posweightInputDataOnly_${EPOCHS}epochs.pt"
...
--validate_w_map \
--use_cls_specific_pos_weight_input_data_only
