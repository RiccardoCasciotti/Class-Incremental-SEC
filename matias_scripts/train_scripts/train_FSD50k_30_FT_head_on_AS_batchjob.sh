#!/bin/bash
#SBATCH --job-name=fsd50k_30_FT_head_on_as
...
#SBATCH --output=outputs/train_FSD50k_30_FT_head_on_AS_out.txt
#SBATCH --error=outputs/train_FSD50k_30_FT_head_on_AS_err.txt
...
MODEL_NAME="trained_model_${MODEL}_${NR_OF_CLASSES}_FT_head_on_${DATASET}_${EPOCHS}epochs.pt"
...
--model_name "$MODEL_NAME" --finetune_classifier
