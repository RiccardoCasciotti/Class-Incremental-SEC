...
#SBATCH --output=outputs/train_outputs/cil_train_AS30plus5_FT_head_w_KLD_T1_IMP10_on_ASplus5_out.txt
#SBATCH --error=outputs/train_outputs/cil_train_AS30plus5_FT_head_w_KLD_T1_IMP10_on_ASplus5_err.txt
...
MODEL_NAME="trained_cil_model_${MODEL}_${NR_OF_CLASSES}plus${CIL_NR_OF_CLASSES}_FT_head_on_${DATASET}_${CIL_NR_OF_CLASSES}_w_KLD_T${T}_IMP${CLASS_IMPACT}_${EPOCHS}epochs.pt"
