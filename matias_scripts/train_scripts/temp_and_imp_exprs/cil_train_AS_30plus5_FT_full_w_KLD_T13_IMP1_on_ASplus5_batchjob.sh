...
#SBATCH --output=outputs/train_outputs/cil_train_AS30plus5_FT_full_w_KLD_T13_IMP1_on_ASplus5_out.txt
#SBATCH --error=outputs/train_outputs/cil_train_AS30plus5_FT_full_w_KLD_T13_IMP1_on_ASplus5_err.txt
