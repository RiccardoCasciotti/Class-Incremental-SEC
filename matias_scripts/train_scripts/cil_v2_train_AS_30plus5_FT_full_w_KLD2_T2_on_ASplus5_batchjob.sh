...
#SBATCH --output=outputs/train_outputs/cil_v2_train_AS30plus5_FT_full_w_KLD2_T2_on_ASplus5_out.txt
#SBATCH --error=outputs/train_outputs/cil_v2_train_AS30plus5_FT_full_w_KLD2_T2_on_ASplus5_err.txt
