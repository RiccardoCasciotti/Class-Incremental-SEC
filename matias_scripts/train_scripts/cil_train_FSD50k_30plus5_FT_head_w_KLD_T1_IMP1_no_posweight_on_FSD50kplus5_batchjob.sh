#!/bin/bash
#SBATCH --job-name=cil_FSD50k30plus5_on_FSD50kplus5_w_KLD_no_posweight
...
#SBATCH --output=outputs/train_outputs/cil_train_FSD50k30plus5_FT_head_w_KLD_T1_IMP1_no_posweight_on_FSD50kplus5_out.txt
#SBATCH --error=outputs/train_outputs/cil_train_FSD50k30plus5_FT_head_w_KLD_T1_IMP1_no_posweight_on_FSD50kplus5_err.txt
