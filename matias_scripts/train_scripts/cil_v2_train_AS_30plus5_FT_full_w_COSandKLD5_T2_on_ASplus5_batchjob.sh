#!/bin/bash
#SBATCH --job-name=cil_v2_AS30plus5_on_ASplus5_w_COSandKLD
...
#SBATCH --output=outputs/train_outputs/cil_v2_train_AS30plus5_FT_full_w_COSandKLD5_T2_on_ASplus5_out.txt
#SBATCH --error=outputs/train_outputs/cil_v2_train_AS30plus5_FT_full_w_COSandKLD5_T2_on_ASplus5_err.txt

cd /pfs/lustrep2/projappl/project_462000765/matias/scripts
SCRIPT_NAME='cil_v2_model_training_script.py'
MODEL='audioset'
...
MODEL_NAME="trained_cil_v2_model_${MODEL}_${NR_OF_CLASSES}plus${CIL_NR_OF_CLASSES}_FT_full_on_${DATASET}_${CIL_NR_OF_CLASSES}_w_COSandKLD${KLD_FACTOR}_T${T}_${EPOCHS}epochs.pt"
