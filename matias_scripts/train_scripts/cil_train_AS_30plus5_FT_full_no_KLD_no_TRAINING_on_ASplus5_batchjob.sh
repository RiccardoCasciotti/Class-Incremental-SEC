...
#SBATCH --output=outputs/train_outputs/cil_train_AS30plus5_FT_full_no_KLD_no_TRAINING_on_ASplus5_out.txt
#SBATCH --error=outputs/train_outputs/cil_train_AS30plus5_FT_full_no_KLD_no_TRAINING_on_ASplus5_err.txt
...
MODEL_NAME="trained_cil_model_${MODEL}_${NR_OF_CLASSES}plus${CIL_NR_OF_CLASSES}_FT_full_on_${DATASET}_${CIL_NR_OF_CLASSES}_no_KLD_no_TRAINING_${EPOCHS}epochs.pt"
