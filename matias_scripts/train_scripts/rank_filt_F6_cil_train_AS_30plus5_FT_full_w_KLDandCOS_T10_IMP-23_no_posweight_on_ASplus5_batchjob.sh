...
#SBATCH --output=outputs/train_outputs/rank_filt_F6_cil_train_AS30plus5_FT_full_w_KLDandCOS_T10_IMP-23_no_posweight_on_ASplus5_out.txt
#SBATCH --error=outputs/train_outputs/rank_filt_F6_cil_train_AS30plus5_FT_full_w_KLDandCOS_T10_IMP-23_no_posweight_on_ASplus5_err.txt
