...
#SBATCH --output=outputs/train_outputs/rank_filt_F8_cil_train_rf_AS40plus5_FT_full_w_KLDandCOS_T10_IMP-23_no_posweight_on_ASplus5_out.txt
#SBATCH --error=outputs/train_outputs/rank_filt_F8_cil_train_rf_AS40plus5_FT_full_w_KLDandCOS_T10_IMP-23_no_posweight_on_ASplus5_err.txt
...
CLASS_IMPACT=-23
FILTER_NR=8
PATH_TO_MODEL_STATE="/pfs/lustrep2/scratch/project_462000765/matias/trained_models/cil_models/trained_rank_filt_F8_cil_model_rf_audioset_35plus5_FT_full_on_audioset_5_w_KLDandCOS_T10_IMP-23_no_posweight_100epochs.pt"
PATH_TO_COMPARISON_MODEL_STATE="/pfs/lustrep2/scratch/project_462000765/matias/trained_models/cil_models/trained_rank_filt_F8_cil_model_rf_audioset_35plus5_FT_full_on_audioset_5_w_KLDandCOS_T10_IMP-23_no_posweight_100epochs.pt"
