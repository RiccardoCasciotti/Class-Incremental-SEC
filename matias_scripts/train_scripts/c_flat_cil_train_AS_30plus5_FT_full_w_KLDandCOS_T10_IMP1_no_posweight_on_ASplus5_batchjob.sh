...
#SBATCH --output=outputs/train_outputs/c_flat_cil_train_AS30plus5_FT_full_w_KLDandCOS_T10_IMP1_no_posweight_on_ASplus5_out.txt
#SBATCH --error=outputs/train_outputs/c_flat_cil_train_AS30plus5_FT_full_w_KLDandCOS_T10_IMP1_no_posweight_on_ASplus5_err.txt
