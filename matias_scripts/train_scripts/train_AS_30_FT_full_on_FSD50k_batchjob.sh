#!/bin/bash
#SBATCH --job-name=as_30_FT_full_on_fsd50k
...
#SBATCH --output=outputs/train_AS_30_FT_full_on_FSD50k_out.txt
#SBATCH --error=outputs/train_AS_30_FT_full_on_FSD50k_err.txt
