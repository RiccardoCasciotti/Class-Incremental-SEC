...
#SBATCH --output=outputs/train_outputs/rank_filt_F8_cil_train_FSD50k30plus5_FT_full_n_KLDorCOS_T10_IMP-23_no_posweight_on_FSD50kplus5_out.txt
#SBATCH --error=outputs/train_outputs/rank_filt_F8_cil_train_FSD50k30plus5_FT_full_n_KLDorCOS_T10_IMP-23_no_posweight_on_FSD50kplus5_err.txt
