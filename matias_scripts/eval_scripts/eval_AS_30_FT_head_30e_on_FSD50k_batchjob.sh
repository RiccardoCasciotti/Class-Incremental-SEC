#!/bin/bash
#SBATCH --job-name=as_model_30_ft_head_eval_on_fsd50k
...
#SBATCH --output=outputs/eval_AS_30_FT_head_30e_on_FSD50k_out.txt
#SBATCH --error=outputs/eval_AS_30_FT_head_30e_on_FSD50k_err.txt

cd /pfs/lustrep2/projappl/project_462000765/matias/scripts
SCRIPT_NAME='model_evaluation_script.py'
MODEL='trained_model_audioset_30_FT_head_on_fsd50k_30epochs.pt'
