#!/bin/bash
#SBATCH --job-name=fsd50k_model_30_eval_on_fsd50k
...
#SBATCH --output=outputs/eval_outputs/eval_FSD50k_30_on_FSD50k_out.txt
#SBATCH --error=outputs/eval_outputs/eval_FSD50k_30_on_FSD50k_err.txt
...
#PATH_TO_MODEL_STATE='trained_model_fsd50k_30.pt'
