#!/bin/bash
#SBATCH --job-name=fsd50k_model_30_ft_full_eval_on_fsd50k
...
#SBATCH --output=outputs/eval_FSD50k_30_FT_full_60e_on_FSD50k_out.txt
#SBATCH --error=outputs/eval_FSD50k_30_FT_full_60e_on_FSD50k_err.txt

cd /pfs/lustrep2/projappl/project_462000765/matias/scripts
SCRIPT_NAME='model_evaluation_script.py'
MODEL='trained_model_fsd50k_30_FT_full_on_audioset_60epochs.pt'
