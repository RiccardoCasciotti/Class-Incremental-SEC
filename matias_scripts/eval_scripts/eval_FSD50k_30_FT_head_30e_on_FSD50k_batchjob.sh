#!/bin/bash
#SBATCH --job-name=fsd50k_model_30_ft_head_eval_on_fsd50k
...
#SBATCH --output=outputs/eval_FSD50k_30_FT_head_30e_on_FSD50k_out.txt
#SBATCH --error=outputs/eval_FSD50k_30_FT_head_30e_on_FSD50k_err.txt
