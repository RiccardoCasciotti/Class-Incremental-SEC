#!/bin/bash
#SBATCH --job-name=FSD50k_model_50_eval_FSD50k
...
#SBATCH --output=outputs/eval_outputs/eval_FSD50k_50_on_FSD50k_out.txt
#SBATCH --error=outputs/eval_outputs/eval_FSD50k_50_on_FSD50k_err.txt
...
LOG_INTERVAL=1
CIL_CLASSES=5
PATH_TO_MODEL_STATE='/pfs/lustrep2/scratch/project_462000765/matias/trained_models/trained_model_fsd50k_50.pt'
