...
#SBATCH --output=outputs/eval_outputs/eval_blankCNN35_on_AS_35_out.txt
#SBATCH --error=outputs/eval_outputs/eval_blankCNN35_on_AS_35_err.txt
...
LOG_INTERVAL=1
CIL_CLASSES=5
PATH_TO_MODEL_STATE='/pfs/lustrep2/scratch/project_462000765/matias/blank_models/blank_cnn14_35.pt'
