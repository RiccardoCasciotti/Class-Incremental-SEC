#!/bin/bash
#SBATCH --job-name=as_model_30_ft_full_eval_on_as
...
#SBATCH --output=outputs/eval_AS_30_FT_full_60e_on_AS_out.txt
#SBATCH --error=outputs/eval_AS_30_FT_full_60e_on_AS_err.txt
