#!/bin/bash
#SBATCH --job-name=rank_filt_F8_cil_model_rf_eval_AS40-5_ft_full_w_KLDandCOS_on_AS45
...
#SBATCH --output=outputs/eval_outputs/rank_filt_F8_cil_eval_rf_AS_40plus5_FT_full5_w_KLDandCOS_T10_IMP-23_no_posweight_100e_on_AS_45_out.txt
#SBATCH --error=outputs/eval_outputs/rank_filt_F8_cil_eval_rf_AS_40plus5_FT_full5_w_KLDandCOS_T10_IMP-23_no_posweight_100e_on_AS_45_err.txt
