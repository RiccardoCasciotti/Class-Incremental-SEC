...
#SBATCH --output=outputs/eval_outputs/eval_AS_35_on_AS_out.txt
#SBATCH --error=outputs/eval_outputs/eval_AS_35_on_AS_err.txt
...
LOG_INTERVAL=1
CIL_CLASSES=5
PATH_TO_MODEL_STATE='/pfs/lustrep2/scratch/project_462000765/matias/trained_models/trained_model_audioset_35.pt'
