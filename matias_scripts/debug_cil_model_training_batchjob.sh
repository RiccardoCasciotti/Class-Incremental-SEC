#!/bin/bash
#SBATCH --job-name=cnn14_cil_training_debug
...
MODEL_NAME="trained_cil_model_${MODEL}_${NR_OF_CLASSES}plus${CIL_NR_OF_CLASSES}_FT_full_on_${DATASET}_${CIL_NR_OF_CLASSES}_w_KLD_${EPOCHS}epochs.pt"
