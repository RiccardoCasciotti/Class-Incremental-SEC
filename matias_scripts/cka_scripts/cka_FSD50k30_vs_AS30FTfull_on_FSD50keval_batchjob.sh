#!/bin/bash
#SBATCH --job-name=cka_comparison_fsd50k_30_vs_as_30_ft_full_on_fsd50k
...
#SBATCH --output=outputs/cka_FSD50k30_vs_AS30FTfull_on_FSD50keval_out.txt
#SBATCH --error=outputs/cka_FSD50k30_vs_AS30FTfull_on_FSD50keval_err.txt
