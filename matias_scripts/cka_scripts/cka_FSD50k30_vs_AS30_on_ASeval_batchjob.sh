#!/bin/bash
#SBATCH --job-name=cka_comparison_fsd50k_30_vs_as_30_on_as
...
#SBATCH --output=outputs/cka_FSD50k30_vs_AS30_on_ASeval_out.txt
#SBATCH --error=outputs/cka_FSD50k30_vs_AS30_on_ASeval_err.txt
