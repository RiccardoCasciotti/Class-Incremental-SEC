#!/bin/bash
#SBATCH --job-name=cka_comparison_FSD50k30_vs_rf_F8_FSD50k30plus5_n_KD_on_FSD50k30_eval
...
#SBATCH --output=outputs/cka_outputs/cka_FSD50k30_vs_rf_F8_FSD50k30plus5_n_KD_on_FSD50k30_eval_out.txt
#SBATCH --error=outputs/cka_outputs/cka_FSD50k30_vs_rf_F8_FSD50k30plus5_n_KD_on_FSD50k30_eval_err.txt

cd /pfs/lustrep2/projappl/project_462000765/matias/scripts
SCRIPT_NAME='cka_script.py'
MODEL_1='trained_model_fsd50k_30.pt'
MODEL_2='cil_models/trained_rank_filt_F8_cil_model_fsd50k_30plus5_FT_full_on_fsd50k_5_n_KLDorCOS_T10_IMP-23_no_posweight_100epochs.pt'
...
MODEL_NAME_2='rf_F8_FSD50k30plus5_n_KD'
