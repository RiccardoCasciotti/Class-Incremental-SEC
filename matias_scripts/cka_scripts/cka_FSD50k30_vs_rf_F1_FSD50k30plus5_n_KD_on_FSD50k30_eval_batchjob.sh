#!/bin/bash
#SBATCH --job-name=cka_comparison_FSD50k30_vs_rf_F1_FSD50k30plus5_n_KD_on_FSD50k30_eval
...
#SBATCH --output=outputs/cka_outputs/cka_FSD50k30_vs_rf_F1_FSD50k30plus5_n_KD_on_FSD50k30_eval_out.txt
#SBATCH --error=outputs/cka_outputs/cka_FSD50k30_vs_rf_F1_FSD50k30plus5_n_KD_on_FSD50k30_eval_err.txt
