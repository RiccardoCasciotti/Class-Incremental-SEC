#!/bin/bash
#SBATCH --job-name=cka_comparison_fsd50k_30_vs_as_30_on_fsd50k
...
#SBATCH --output=outputs/cka_FSD50k30_vs_AS30_on_FSD50keval_out.txt
#SBATCH --error=outputs/cka_FSD50k30_vs_AS30_on_FSD50keval_err.txt

cd /pfs/lustrep2/projappl/project_462000765/matias/scripts
SCRIPT_NAME='cka_script.py'
MODEL_1='trained_model_fsd50k_30.pt'
MODEL_2='trained_model_audioset_30.pt'
