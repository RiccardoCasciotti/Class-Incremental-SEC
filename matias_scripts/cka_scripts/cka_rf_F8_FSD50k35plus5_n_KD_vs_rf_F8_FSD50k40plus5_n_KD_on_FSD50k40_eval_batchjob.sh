#!/bin/bash
#SBATCH --job-name=cka_comparison_rf_F8_FSD50k35plus5_n_KD_vs_rf_F8_FSD50k40plus5_n_KD_on_FSD50k40_eval
...
#SBATCH --output=outputs/cka_outputs/cka_rf_F8_FSD50k35plus5_n_KD_vs_rf_F8_FSD50k40plus5_n_KD_on_FSD50k40_eval_out.txt
#SBATCH --error=outputs/cka_outputs/cka_rf_F8_FSD50k35plus5_n_KD_vs_rf_F8_FSD50k40plus5_n_KD_on_FSD50k40_eval_err.txt
...
MODEL_2='cil_models/trained_rank_filt_F8_cil_model_rf_fsd50k_40plus5_FT_full_on_fsd50k_5_n_KLDorCOS_T10_IMP-23_no_posweight_100epochs.pt'
...
MODEL_NAME_2='rf_F8_FSD50k40plus5_n_KD'
