#!/bin/bash
#SBATCH --job-name=cka_comparison_AS30_vs_rf_F8_AS30plus5_n_KD_on_AS30_eval
...
#SBATCH --output=outputs/cka_outputs/cka_AS30_vs_rf_F8_AS30plus5_n_KD_on_AS30_eval_out.txt
#SBATCH --error=outputs/cka_outputs/cka_AS30_vs_rf_F8_AS30plus5_n_KD_on_AS30_eval_err.txt

cd /pfs/lustrep2/projappl/project_462000765/matias/scripts
SCRIPT_NAME='cka_script.py'
MODEL_1='trained_model_audioset_30.pt'
MODEL_2='cil_models/trained_rank_filt_F8_cil_model_audioset_30plus5_FT_full_on_audioset_5_n_KLDorCOS_T10_IMP-23_no_posweight_100epochs.pt'
...
MODEL_NAME_1='AS30'
MODEL_NAME_2='rf_F8_AS30plus5_n_KD'
