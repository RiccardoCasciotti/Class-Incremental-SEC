#!/bin/bash
#SBATCH --job-name=cka_comparison_AS30_vs_rf_F1_AS30plus5_n_KD_on_AS30_eval
...
#SBATCH --output=outputs/cka_outputs/cka_AS30_vs_rf_F1_AS30plus5_n_KD_on_AS30_eval_out.txt
#SBATCH --error=outputs/cka_outputs/cka_AS30_vs_rf_F1_AS30plus5_n_KD_on_AS30_eval_err.txt
