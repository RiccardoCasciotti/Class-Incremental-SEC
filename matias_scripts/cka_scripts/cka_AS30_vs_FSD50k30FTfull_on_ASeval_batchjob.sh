#!/bin/bash
#SBATCH --job-name=cka_comparison_as_30_vs_fsd50k_30_ft_full_on_as
...
#SBATCH --output=outputs/cka_AS30_vs_FSD50k30FTfull_on_ASeval_out.txt
#SBATCH --error=outputs/cka_AS30_vs_FSD50k30FTfull_on_ASeval_err.txt
