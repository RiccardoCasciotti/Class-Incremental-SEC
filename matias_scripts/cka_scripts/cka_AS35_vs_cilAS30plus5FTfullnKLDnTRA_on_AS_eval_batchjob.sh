#!/bin/bash
#SBATCH --job-name=cka_AS35_vs_AS30plus5_nTRA
...
#SBATCH --output=outputs/cka_outputs/cka_AS35_vs_AS30plus5FTfullnKLDnTRA_out.txt
#SBATCH --error=outputs/cka_outputs/cka_AS35_vs_AS30plus5FTfullnKLDnTRA_err.txt

cd /pfs/lustrep2/projappl/project_462000765/matias/scripts
SCRIPT_NAME='cka_script.py'
MODEL_1='trained_model_audioset_35.pt'
MODEL_2='cil_models/trained_cil_model_audioset_30plus5_FT_full_on_audioset_5_no_KLD_no_TRAINING_100epochs.pt'
...
MODEL_NAME_1='AS35'
MODEL_NAME_2='cil30+5FTfullnKLDnTRA'
