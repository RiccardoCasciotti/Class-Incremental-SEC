#!/bin/bash
#SBATCH --job-name=cka_comparison_debug
...
MODEL_1='cil_models/trained_cil_model_audioset_30plus5_FT_full_on_audioset_5_no_KLD_100epochs.pt'
MODEL_2='cil_models/trained_cil_model_blankCNN30plus5_FT_full_on_audioset_5_no_KLD_100epochs.pt'
...
MODEL_NAME_1='cilAS30+5FTfullOnAS5nKLD'
MODEL_NAME_2='cilBLANK30+5FTfullOnAS5nKLD'
