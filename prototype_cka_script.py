...
if __name__ == '__main__':
    ...
    # Initialize randomness for data loading
    ...
    # Drop last suggested by CKA library author for avoiding dimensional
    # mismatches
    ...
    end_time = time.time()
    print(f"Time taken before doing CKA: {round(end_time-start_time, 2)} seconds.")
